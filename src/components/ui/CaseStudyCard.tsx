...
export function CaseStudyCard({
    ...
    return (
        ...
        >
            <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-[#10A882]/0 group-hover:bg-[#10A882]/50 group-hover:shadow-[0_0_20px_rgba(53,208,127,0.4)] transition-all duration-500 ease-out" />
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto transform group-hover:translate-x-2 transition-transform duration-500 ease-out">
                ...
                <div className="flex-1 lg:max-w-md">
                    <div className="mb-6 flex items-center justify-between">
                        ...
                        <ArrowRight className="text-[#707A75] w-5 h-5 -rotate-45 group-hover:rotate-0 group-hover:text-[#10A882] transition-all duration-500 ease-out" />
                    </div>
                ...
                <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-16">
                    ...
                    <div className="sm:col-span-2 border-t border-[#B4FFD7]/10 pt-8 mt-auto">
                        <div className="flex flex-col sm:flex-row sm:items-start gap-8">
                            ...
                            <div className="flex-1">
                                <h4 className="font-sans font-semibold text-[#10A882] uppercase tracking-wider text-[11px] mb-3 group-hover:drop-shadow-[0_0_10px_rgba(53,208,127,0.3)] transition-all">The Outcome</h4>
