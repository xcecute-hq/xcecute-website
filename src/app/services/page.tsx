...
const capabilities = [
    ...
    },
    {
        ...
        number: "03",
        title: "AI Solutions",
        description: "Practical AI for real problems.\n\nAI is most useful when it solves something specific. We integrate AI into products and business processes where it can genuinely improve how people work by understanding information, generating content, and assisting users.",
            ...
            <section className="pb-32 px-4 sm:px-6 lg:px-8 border-t border-[#B4FFD7]/10 bg-[#0A0F0D]">
                <div className="max-w-6xl mx-auto">
                    {capabilities.map((cap, index) => (
                        <div id={cap.id} key={cap.number} className="scroll-mt-32">
                            <ScrollReveal delay={index * 0.05} className="group border-b border-[#B4FFD7]/10 last:border-b-0">
                                <div className="py-16 sm:py-24 hover:bg-[#111714]/60 transition-all duration-500 ease-out px-4 sm:px-8 relative">
                                    <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-[#10A882]/0 group-hover:bg-[#10A882]/40 group-hover:shadow-[0_0_20px_rgba(53,208,127,0.4)] transition-all duration-500 ease-out" />
                                    ...
                                    <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 transform group-hover:translate-x-3 transition-transform duration-500 ease-out">
                                        <div className="lg:w-2/5 flex flex-col">
                                            <div className="mb-6 flex items-center justify-between opacity-50 group-hover:opacity-100 transition-opacity">
                                                <span className="font-sans font-medium text-2xl text-[#10A882]">{cap.number}</span>
                                                <ArrowRight className="w-5 h-5 text-[#10A882] -translate-x-4 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500 ease-out" />
                                            </div>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8">
                                                    {cap.deliverables.map((item, i) => (
                                                        <div key={i} className="flex items-center gap-3">
                                                            <Check className="w-4 h-4 text-[#10A882]/40 group-hover:text-[#10A882] transition-colors duration-500 shrink-0" />
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <ScrollReveal>
                        ...
                        <div className="font-sans text-xl text-[#A7B0AB] leading-relaxed max-w-2xl mx-auto space-y-6">
                            <p>Using too much AI without clear thought or purpose is a mistake. We don't believe every business needs a custom platform. And we don't believe adding more technology automatically creates more value.</p>
                ...
                <div className="max-w-4xl mx-auto flex flex-col items-center">
                    <ScrollReveal className="text-center">
                        ...
                        <Link href="/contact" className="inline-flex items-center text-[15px] tracking-wide font-medium text-[#F1F4F2] bg-[#111714] border border-[#B4FFD7]/10 px-8 py-4 rounded-full group hover:bg-[#151D19] hover:border-[#10A882]/25 hover:shadow-[0_0_30px_rgba(53,208,127,0.06)] transition-all duration-300">
                            Contact Us
                            <ArrowRight className="w-5 h-5 ml-3 group-hover:translate-x-1 group-hover:text-[#10A882] transition-all" />
                        </Link>
                    </ScrollReveal>
                </div>
            </section>
